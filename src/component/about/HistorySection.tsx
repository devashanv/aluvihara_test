...
const HistorySection: React.FC = () => {
  return (
    <div className=" h-full lg:py-20 md:py-20">
      ...
      <h1
        className="text-[38px] lg:text-header text-center lg:text-left font-regular  w-5/6 mx-auto flex items-center justify-center lg:items-left lg:justify-end lg:mt-[-90px]">History</h1>

      {/* Heading for Tablet and Mobile */}
      <div className="block lg:hidden px-4 mt-4">
        <h1 className="text-[36px] md:text-[48px] text-center text-[#181415] leading-tight hidden">
          History
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 w-[90%] xl:w-5/6 gap-10 items-center lg:mt-20">
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-6 justify-center items-center z-30">
            ...
            <img
              src={Puskole}
              alt="Palm Leaf Book"
              className="w-[340px] sm:w-[380px] md:w-full h-[260px] sm:h-[320px] md:h-[400px] rounded-lg object-cover"
            />
          </div>

          <div className="flex flex-col gap-6 pl-5 pr-5 text-[#4F4C53]">
            <h2 className="hidden lg:block text-[10px] flex flex-col sm:text-[18px] md:text-[28px] font-semibold text-[#181615] leading-snug">
              Unveiling The Rich History Of{" "}
