    ...
    <div className="">
      <section className="lg:mt-40  py-10 lg:py-20  relative">
        ...
        <div className="bg-[#F7F6F6]  pb-4  px-4 md:px-20">
          <div className="relative  z-10 max-w-6xl lg:right-[-200px] px-4 flex flex-col">
            <div className="w-[2px]">
              <img
                src={Line}
                alt=""
                className="absolute hidden lg:block h-full t-0 -z-940 left-18"
              />
            </div>
            <h2 className="lg:mb-20 lg:mt-[-80px] text-2xl md:text-4xl font-semibold lg:right-[-450px] text-black mb-12 relative z-10">
            ...
            {steps.slice(0, visibleCount).map((step, index) => (
              <div key={index} className="mb-10 lg:mb-0 lg:ml-10 lg:mt-15">
                ...
                >
                  <div
                    className={`w-10 h-10  bg-[#F7F6F6] z-100 rounded-full flex items-center justify-center font-bold border-2 ${
                      activeStep === index
                  ...
                  <div
                    className={`w-full max-w-4xl bg-[#DADADA] text-[#4B4B4B]/90 lg:left-0 rounded-2xl p-3 flex flex-col justify-between  pr-4 text-lg ${
                      activeStep === index
