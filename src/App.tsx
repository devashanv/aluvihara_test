  ...
  return (
    <>
      ...
      <main>
        ...
        {/* palm leaves section */}
        <section className="relative flex flex-col w-full mx-auto py-2 h-auto lg:h-[90dvh] mt-15 flex bg-[url('process-banner.svg')] bg-fit bg-no-repeat bg-cover items-center justify-center px-5 lg:px-10 py-10 lg:py-2 md:mt-20 ">
