...
const timelineData = [
  ...
  },
  {
    date: "4th Century",
    title: "Dummy Data",
    description: "Dummy data for testing 'Show More' functionality.",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/e/e3/Tripitaka_Koreana_woodblocks.jpg",
  },
];
...
const History: React.FC = () => {
  ...
  return (
    ...
    <div className="text-gray-800">
      ...
      <section className="relative w-full h-auto lg:h-[90dvh] pb-20 px-6 p-5 md:px-20 lg:px-0 mt-10 md:mt-20 lg:mt-20">
        ...
        <div className="lg:w-5/6 mx-auto h-full flex lg:flex-row flex-col">
          ...
          <div className="mb-6 w-full lg:w-3/5 lg:px-20">
            ...
            <h2 className="text-4xl text-center lg:text-left md:text-7xl mb-3 font-bold text-black leading-tight lg:ml-20">
              <span className="text-black">History</span>
            </h2>
            <p className="mb-4 text-[18px] text-justify lg:mt-10">
              Aluvihara Temple, located in Matale, Sri Lanka, is a historically significant
              Buddhist site. It is renowned as the place where the Tipitaka (Buddhist
              scriptures) were first written on palm leaves during the period of King
              Walagamba (~89 BCE). This temple stands as a beacon of Buddhist heritage,
              preserving teachings for generations to come.
            </p>
            <p className="text-justify">
              It stands as a testament to Sri Lanka’s Buddhist heritage, deeply intertwined
              with King Walagamba’s efforts to preserve Buddhism. From its role in writing
              the Tipitaka to its present-day significance, this sacred site continues to
              be a beacon of wisdom and devotion.
            </p>
          </div>
        </div>
      ...
      {/* tipitaka */}
      <section
      className="w-full md:mt-10 bg-neutral-100 h-auto lg:h-[90dvh] flex lg:mt-40 justify-center items-center">
        <div
        className="w-5/6 mx-auto h-auto lg:h-10/12 flex flex-col lg:flex-row justify-between">
          <section
          className="w-full lg:w-3/5">
            <h1
            className="mb-5 lg:mb-0 text-[48px] font-bold text-center lg:text-left lg:text-[96px] lg:mt-[-160px] flex flex-col gap-0">
              <span className="text-[36px] lg:text-[48px] text-primary lg:mb-[-40px]">The</span>
              Tipitaka
            </h1>
            <section
              className="text-justify lg:mt-15">
                <p className="text-[18px] mb-4 leading-relaxed">
                  The Tipitaka, also known as the Pali Canon, is the foundational scripture of
                  Theravada Buddhism. It is divided into three “baskets” (Pitaka): the Vinaya
                  Pitaka, which contains rules for monastic discipline; the Sutta Pitaka, which
                  includes sermons and teachings attributed to the Buddha; and the Abhidhamma
                  Pitaka, which offers philosophical and doctrinal analysis. These texts are
                  written in Pali and serve as a comprehensive guide to the Buddha’s teachings,
                  covering ethical conduct, meditation practices, and wisdom.
                </p>
                <p className="text-[18px] text-gray-800 leading-relaxed">
                  In Buddhist culture, the Tipitaka is revered as the ultimate authority on the
                  Buddha’s teachings. It plays a crucial role in the daily lives of monks and
                  laypeople alike. The preservation and study of the Tipitaka are considered
                  vital for maintaining the purity of the Buddha’s teachings and have a
                  significant influence on Buddhist values and education worldwide.
                </p>
            </section>
          </section>
          ...
          {/* image */}
          <section
          className="w-full lg:w-2/5 flex justify-center items- mt-10 lg:mt-0">
            <img
                src={tiptika}
                alt="Tipitaka Scripture"
                className="rounded-xl w-64 md:w-96 h-auto"
              />
          </section>
